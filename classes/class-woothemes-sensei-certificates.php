...
class WooThemes_Sensei_Certificates {
	...
	public function download_certificate() {
		...
		if ( $this->can_view_certificate( get_the_ID() ) ) {
			...
			$filename = $upload_path . '/cert-' . $hash . '.pdf';
	...
	public function replace_data_field_template_tags($field_value, $field_key, $is_preview, $student, $course)
	{
        ...
        $replacement_values = apply_filters("sensei_certificate_variables", array("replacement_values" => $replacement_values, "course_id" => $course->ID));
